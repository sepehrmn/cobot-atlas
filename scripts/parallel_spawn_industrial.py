...
"""
Multi-process mesh generation for Industrial Dataset - each key runs in its own process(es).
...
OUTPUT_DIR = SCRIPT_DIR / "output_industrial"
...
def main():
    # Load manifests
    manifest_files = ["mesh_manifest_industrial.json"]
    all_meshes = []
    seen_ids = set()
    ...
    for key_info in keys:
        ...
        # User requested 10 processes per key
        num_workers = 10
